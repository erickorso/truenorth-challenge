...
describe('App Component', () => {
    ...
    it("should call notesService.saveNote() method after the form is submitted", async () => {
      ...
      expect(
        mockService.saveNote,
        "expected app to call saveNote() when form is submitted"
      ).to.have.been.calledWith(selectedNote);
    });
    ...
    it("should add a new note to the list after the note is saved", async () => {
      ...
      wrapper
        .find('[name="title"]')
        .simulate("change", { target: { name: "title", value: "buy milk" } });
      wrapper.find('[name="text"]').simulate("change", {
      ...
      expect(mockService.saveNote, "saveNote() not called when form submitted")
      ...
      expect(mockService.getNotes, "getNotes() not called after saveNote()").to
      ...
      expect(
        wrapper.find(".list-group-item").length,
        "saved note was not added to list"
      ).to.eq(mockService.notes.length);
