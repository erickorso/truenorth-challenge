...
describe('NotesList Component', () => {
    it("should show list of notes", () => {
      ...
      expect(
        wrapper.find(".list-group-item"),
        "List must have .list-group-item element for each note"
      ).to.have.lengthOf(notes.length);
    });
    ...
    it("should add `active` class to a note after it was selected", () => {
      ...
      expect(
        item,
        `expected selected note to have 'active' class`
